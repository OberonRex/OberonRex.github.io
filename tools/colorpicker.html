...
<table width="100%">
    <tr>
    	<td class="js-btn-colormap mButton"  data-colormap="none" border=1 width=50%>
    		Uncorrected
    	</td>
    	<td class="js-btn-colormap mButton" data-colormap="sunlight" border=1 width=50%>
		Sunlight
    	</td>
    </tr>
</table>
    ...
    <br>
	<svg version="1.1" style="background:blue;" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
